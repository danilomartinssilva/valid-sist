exports.creds = {
  ...
  // feature.
  identityMetadata: 'https://login.microsoftonline.com/B2CValidcodePRD.onmicrosoft.com/v2.0/.well-known/openid-configuration',
  // or equivalently: 'https://login.microsoftonline.com/<tenant_guid>/v2.0/.well-known/openid-configuration'

  // Required, the client ID of your app in AAD  
  clientID: '90ee2d3c-591d-40de-b2e3-33e35a391f97',
  ...
  redirectUrl: 'https://valid-sist.herokuapp.com/auth/openid/return',
  ...
  clientSecret: 'j05cE]h0=U1~D7RXh9I~eBrN',
...
exports.destroySessionUrl =
  ...
  '&post_logout_redirect_uri=https://valid-sist.herokuapp.com/';
